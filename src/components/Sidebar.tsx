    ...
    <>
      ...
      <motion.aside
        className={clsx(
          ...
          // Mobile positioning
          "md:translate-x-0",
          isOpen ? "translate-x-0 w-[80vw]" : "-translate-x-full"
        )}
      >
        <div className="flex flex-col h-full p-4">
          ...
          <div className="flex items-center justify-between mb-8 px-2">
            <div className={clsx("flex items-center gap-3 overflow-hidden", isDesktopCollapsed && "justify-center w-full")}>
              <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-blue-600 to-cyan-400 flex items-center justify-center shrink-0">
            ...
            <button 
              ...
              className="hidden md:flex p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-white/5 text-gray-500 transition-colors"
            >
          ...
          <div className="mt-auto pt-6 border-t border-gray-200 dark:border-white/10">
            <div className={clsx("flex items-center gap-3 p-2 rounded-xl transition-colors hover:bg-gray-100 dark:hover:bg-white/5 cursor-pointer", isDesktopCollapsed && "justify-center")}>
              ...
              <LogOut className={clsx("w-4 h-4 text-gray-400 ml-auto hover:text-red-500", isDesktopCollapsed && "hidden")} />
            </div>
          </div>
        </div>
      </motion.aside>
